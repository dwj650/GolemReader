...
| **S4** | Text → sentences: thin EPUB text extraction + composite index + segmentation | F-018 (thin), F-027, F-028 |
| **S5** | One voice speaks: voice load + audio pipeline → first synthesized sentence | F-048, F-008 |
